...
- **My Notes** — personal notes on every topic (select text → “+ Add to notes”), a general notebook, search, export as .txt, backup/restore as .json; saved in the browser (localStorage)
...
assets/notes.js     personal notes (localStorage), notes panels and the My Notes page
```
